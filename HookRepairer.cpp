...
BEGIN_MESSAGE_MAP(CHookRepairerApp, CWinApp)
...
CHookRepairerApp::CHookRepairerApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CHookRepairerApp 物件

CHookRepairerApp theApp;


// CHookRepairerApp 初始設定

BOOL CHookRepairerApp::InitInstance()
{
